      ...
      <div class="lg:grid lg:grid-cols-2 lg:gap-8">
        ...
        <div class="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative hidden lg:block">
          <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0">
            ...
            <div ref="lottieRef" class="w-full lg:absolute lg:inset-y-0 lg:-left-20 lg:h-full lg:w-auto lg:max-w-none lg:flex lg:justify-center">
              <!-- <img src="/assets/laptop_poster.png" style="aspect-ratio: 16/9" /> -->
            </div>
          </div>
        </div>
      </div>
